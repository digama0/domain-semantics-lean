...
inductive IsDefEqStrong (env : VEnv) (uvars : Nat) :
  ...
  | sortDF : Γ ⊢ .sort l ≡ .sort l : .sort true
  | appDF :
    Γ ⊢ A : .sort u →
    A::Γ ⊢ B : .sort v →
    Γ ⊢ f ≡ f' : .forallE A B →
  ...
  | defeqDF :
    Γ ⊢ A ≡ B : .sort u → Γ ⊢ e1 ≡ e2 : A → Γ ⊢ e1 ≡ e2 : B
  | beta :
...
local notation:65 Γ " ⊢ " e " : " A:30 => HasTypeStrong env uvars Γ e A true
local notation:65 Γ " ⊢ " e " :! " A:30 => HasTypeStrong env uvars Γ e A false
local notation:65 Γ " ⊢ " e1 " ≡ " e2 " : " A:30 => IsDefEqStrong env uvars Γ e1 e2 A
...
theorem IsDefEqStrong.weakN (W : Ctx.LiftN n k Γ Γ') (H : env.IsDefEqStrong U Γ e1 e2 A) :
  ...
  | @eta Γ a u B v e _ _ _ _ _ _ ih1 ih2 ih3 ih4 ih5 ih6 =>
    have := IsDefEqStrong.eta (ih1 W) (ih2 W.succ) ?_ (ih4 W) ?_ ?_
...
theorem IsDefEqStrong.defeq (H : IsDefEqStrong env U Γ e1 e2 A) : env.IsDefEq U Γ e1 e2 A := by
  ...
  | sortDF => exact .sortDF
  | appDF _ _ _ _ _ _ _ ih1 ih2 => exact .appDF ih1 ih2
  | lamDF _ _ _ _ _ ih1 _ _ ih2 => exact .lamDF ih1 ih2
  | forallEDF _ _ _ ih1 ih2 => exact .forallEDF ih1 ih2
  | defeqDF _ _ ih1 ih2 => exact .defeqDF ih1 ih2
  | beta _ _ _ _ _ _ _ _ ih1 ih2 => exact .beta ih1 ih2
  | eta _ _ _ _ _ _ _ _ _ ih => exact .eta ih
...
theorem IsDefEqStrong.mono
  ...
  | trans _ _ ih1 ih2 => exact .trans ih1 ih2
  | sortDF => exact .sortDF
  | appDF _ _ _ _ _ ih1 ih2 ih3 ih4 ih5 => exact .appDF ih1 ih2 ih3 ih4 ih5
  | lamDF _ _ _ _ _ ih1 ih2 ih3 ih4 ih5 => exact .lamDF ih1 ih2 ih3 ih4 ih5
  | forallEDF _ _ _ ih1 ih2 ih3 => exact .forallEDF ih1 ih2 ih3
  | defeqDF _ _ ih1 ih2 => exact .defeqDF ih1 ih2
  | beta _ _ _ _ _ _ ih1 ih2 ih3 ih4 ih5 ih6 => exact .beta ih1 ih2 ih3 ih4 ih5 ih6
  | eta _ _ _ _ _ _ ih1 ih2 ih3 ih4 ih5 ih6 => exact .eta ih1 ih2 ih3 ih4 ih5 ih6
  | proofIrrel _ _ _ ih1 ih2 ih3 => exact .proofIrrel ih1 ih2 ih3
